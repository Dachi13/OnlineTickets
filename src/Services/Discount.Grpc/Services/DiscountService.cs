    ...
    : DiscountProtoService.DiscountProtoServiceBase
{
    ...
    {
        var coupon = await repository.GetDiscountAsync(request.CategoryId) ?? new Coupon
    ...
    public override async Task<CouponModel> UpdateDiscount(UpdateDiscountRequest request, ServerCallContext context)
    {
        ...
        var result = await repository.GetDiscountAsync(coupon.CategoryId);
    ...
    {
        var coupon = await repository.GetDiscountAsync(request.CategoryId);
